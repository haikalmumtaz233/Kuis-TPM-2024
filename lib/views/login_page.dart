...
import 'package:kuis_123210062/views/game_list.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _login(BuildContext context) {
    ...
    // Jika username sama dengan 'haikalmumtaz23' dan password sama dengan 'haraka123', arahkan ke halaman beranda
    if (username == '123210062' && password == 'admin') {
